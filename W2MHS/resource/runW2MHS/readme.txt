...
================================
-w2mhs.ctf (component technology file)
-w2mhs 
-run_w2mhs.sh (shell script run to temporarily set environment variables and execute the 
               application)
   -to run the shell script, type
   
       ./run_w2mhs.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2010a/v7141, run the shell script as:
       ...
       ./run_w2mhs.sh /mathworks/home/application/R2010a/v7141
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_w2mhs.sh /mathworks/devel/application/matlab
-MCRInstaller.bin
...
w2mhs uses for successful execution of exported M functions. 
    ...
    Linux                   LD_LIBRARY_PATH
     ...
     ii. Set the path by doing one of the following:
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_w2mhs.sh 
