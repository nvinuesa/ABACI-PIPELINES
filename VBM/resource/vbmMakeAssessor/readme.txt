...
================================
-vbmMakeAssessor.ctf (component technology file)
-vbmMakeAssessor 
-run_vbmMakeAssessor.sh (shell script run to temporarily set environment variables and 
                         execute the application)
   -to run the shell script, type
   
       ./run_vbmMakeAssessor.sh <mcr_directory> <argument_list>
       
    at Unix or Mac command prompt. <mcr_directory> is the directory 
    where version 7.14.1 of MCR is installed or the directory where 
    MATLAB is installed on the machine. <argument_list> is all the 
    arguments you want to pass to your application. For example, 

    If you have version 7.14.1 of MCR installed in 
    /mathworks/home/application/R2010a/v7141, run the shell script as:
    
       ./run_vbmMakeAssessor.sh /mathworks/home/application/R2010a/v7141
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_vbmMakeAssessor.sh /mathworks/devel/application/matlab
-MCRInstaller.bin
...
vbmMakeAssessor uses for successful execution of exported M functions. 
    ...
    Linux                   LD_LIBRARY_PATH
     ...
     ii. Set the path by doing one of the following:
        ...
        . Add the MCR directory to the environment variable by issuing 
          the following commands:
            ...
            setenv LD_LIBRARY_PATH
                <mcr_root>/v7141/runtime/glnxa64:
                <mcr_root>/v7141/sys/os/glnxa64:
                <mcr_root>/v7141/sys/java/jre/glnxa64/jre/lib/amd64/native_threads:
                <mcr_root>/v7141/sys/java/jre/glnxa64/jre/lib/amd64/server:
                <mcr_root>/v7141/sys/java/jre/glnxa64/jre/lib/amd64 
            setenv XAPPLRESDIR <mcr_root>/v7141/X11/app-defaults
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_vbmMakeAssessor.sh 
